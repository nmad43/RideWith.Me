 ...
 * on 2013-12-03 at 19:53:29 UTC 
 * Modify at your own risk.
 */

package com.g5.ridewithme.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUser extends UserendpointRequest<com.g5.ridewithme.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.String id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.g5.ridewithme.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link com.g5.ridewithme.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.g5.ridewithme.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.g5.ridewithme.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.g5.ridewithme.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.g5.ridewithme.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.g5.ridewithme.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.g5.ridewithme.userendpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.g5.ridewithme.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.g5.ridewithme.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.g5.ridewithme.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.g5.ridewithme.userendpoint.model.User.class);
    }
